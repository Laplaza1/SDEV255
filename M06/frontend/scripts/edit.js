...
async function updateSong(){
    ...
    const song = {
        ...
        artist:document.querySelector("#artist").value = song.artist,
        releaseDate:document.querySelector("#released").value = song.releaseDate.substring(0,10),
        popularity:document.querySelector("#popularity").value = song.popularity,
